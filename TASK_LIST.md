...
### T009: 클럽 생성 및 관리 [P0] - 1주
- [ ] Club 데이터 모델 정의 (Firestore)
- [ ] 클럽 생성 폼 UI 구현
- [ ] 클럽 생성 API 함수 구현
- [ ] 클럽 목록 조회 및 표시
- [ ] 클럽 상세 정보 페이지

### T010: 멤버 초대 시스템 [P0] - 0.5주
- [ ] 초대 링크 생성 기능
- [ ] 이메일 초대 기능 (Firebase Functions)
- [ ] 초대 수락/거절 로직
- [ ] 대기 중인 초대 관리 UI

### T011: 역할 기반 권한 시스템 [P0] - 0.5주
- [ ] 역할 데이터 모델 (organizer/member/guest)
- [ ] 권한 검사 hooks (`usePermissions`)
- [ ] 역할별 UI 조건부 렌더링
- [ ] Firestore 보안 규칙 초기 구현

### T012: 클럽 대시보드 [P0] - 0.5주
- [ ] 클럽 대시보드 페이지 UI
- [ ] 멤버 디렉토리 컴포넌트
- [ ] 클럽 통계 표시 (멤버 수, 이벤트 수)
- [ ] 클럽 설정 관리 UI
